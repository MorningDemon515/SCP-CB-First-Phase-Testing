...
Function LoadRMesh(file$,rt.RoomTemplates)
	...
	ElseIf isRMesh$="RoomMesh.HasTriggerBox"
		hasTriggerBox% = True
	Else
		RuntimeError "“"+file+"”不是RMESH文件("+isRMesh+")"
	EndIf
			...
			If fr\grid[(ty*gridsize)+tx]=1 Then 
				...
				If tile_type > 0 Then 
					...
					If (ty Mod 3)=2 And itemPlaced[Floor(ty/3)]=False Then
						...
						it.Items = CreateItem("日志#"+Int(Floor(ty/3)+1), "paper", 0,0.5,0)
			...
			If r\grid\grid[x+(y*gridsz)]>0 Then
				...
				Select r\grid\grid[x+(y*gridsz)]
					...
					Case ROOM4+2
						...
						it = CreateItem("夜视仪", "nvgoggles",r\x+x*2.0-(Sin(EntityYaw(tile_entity,True))*504.0*RoomScale)+(Cos(EntityYaw(tile_entity,True))*16.0*RoomScale), 8.0+(80.0*RoomScale), r\z+y*2.0+(Cos(EntityYaw(tile_entity,True))*504.0*RoomScale)+(Sin(EntityYaw(tile_entity,True))*16.0*RoomScale))
						EntityType (it\collider, HIT_ITEM)
				End Select
...
;			EntityParent dp\cam,fr\Forest_Pivot
			...
			it = CreateItem("SCP-860-1文档", "paper", r\x + 672.0 * RoomScale, r\y + 176.0 * RoomScale, r\z + 335.0 * RoomScale)
			RotateEntity it\collider, 0, r\angle+10, 0
			EntityParent(it\collider, r\obj)
			
			it = CreateItem("SCP-860文档", "paper", r\x + 1152.0 * RoomScale, r\y + 176.0 * RoomScale, r\z - 384.0 * RoomScale)
		...
		Case "roompj"
			;[Block]
			it = CreateItem("SCP-372文档", "paper", r\x + 800.0 * RoomScale, r\y + 176.0 * RoomScale, r\z + 1108.0 * RoomScale)
			RotateEntity it\collider, 0, r\angle, 0
			EntityParent(it\collider, r\obj)
			
			it = CreateItem("对讲机", "radio", r\x + 800.0 * RoomScale, r\y + 112.0 * RoomScale, r\z + 944.0 * RoomScale)
			it\state = 80.0
			EntityParent(it\collider, r\obj)
		...
		Case "room2testroom2"
			...
			it = CreateItem("二级钥匙卡", "key2", r\x - 914.0 * RoomScale, r\y + 137.0 * RoomScale, r\z + 61.0 * RoomScale)
			EntityParent(it\collider, r\obj)
			
			it = CreateItem("S-NAV 300导航仪", "nav", r\x - 312.0 * RoomScale, r\y + 264.0 * RoomScale, r\z + 176.0 * RoomScale)
		...
		Case "room2storage"
			...
			it = CreateItem("SCP-939文档", "paper", r\x + 352.0 * RoomScale, r\y + 176.0 * RoomScale, r\z + 256.0 * RoomScale)
			RotateEntity it\collider, 0, r\angle+4, 0
			EntityParent(it\collider, r\obj)
			
			it = CreateItem("9V电池", "bat", r\x + 352.0 * RoomScale, r\y + 112.0 * RoomScale, r\z + 448.0 * RoomScale)
			EntityParent(it\collider, r\obj)
			
			it = CreateItem("空杯子", "emptycup", r\x-672*RoomScale, 240*RoomScale, r\z+288.0*RoomScale)
			EntityParent(it\collider, r\obj)
			
			it = CreateItem("一级钥匙卡", "key1", r\x - 672.0 * RoomScale, r\y + 240.0 * RoomScale, r\z + 224.0 * RoomScale)
			EntityParent(it\collider, r\obj)
			;[End Block]
		Case "room2sroom"
			;[Block]
			...
			it = CreateItem("一些SCP-420-J", "420", r\x + 1776.0 * RoomScale, r\y + 400.0 * RoomScale, r\z + 427.0 * RoomScale)
			EntityParent(it\collider, r\obj)
			
			it = CreateItem("一些SCP-420-J", "420", r\x + 1808.0 * RoomScale, r\y + 400.0 * RoomScale, r\z + 435.0 * RoomScale)
			EntityParent(it\collider, r\obj)
			
			it = CreateItem("五级钥匙卡", "key5", r\x + 2232.0 * RoomScale, r\y + 392.0 * RoomScale, r\z + 387.0 * RoomScale)
			RotateEntity it\collider, 0, r\angle, 0, True
			EntityParent(it\collider, r\obj)
			
			it = CreateItem("核设备文档", "paper", r\x + 2248.0 * RoomScale, r\y + 440.0 * RoomScale, r\z + 372.0 * RoomScale)
			EntityParent(it\collider, r\obj)
			
			it = CreateItem("对讲机", "radio", r\x + 2240.0 * RoomScale, r\y + 320.0 * RoomScale, r\z + 128.0 * RoomScale)
			EntityParent(it\collider, r\obj)
			;[End Block]
		Case "room2shaft"
			;[Block]
			...
			it = CreateItem("三级钥匙卡", "key3", r\x + 1119.0 * RoomScale, r\y + 233.0 * RoomScale, r\z + 494.0 * RoomScale)
			EntityParent(it\collider, r\obj)
			
			it = CreateItem("急救箱", "firstaid", r\x + 1035.0 * RoomScale, r\y + 145.0 * RoomScale, r\z + 56.0 * RoomScale)
			EntityParent(it\collider, r\obj) : RotateEntity(it\collider, 0, 90, 0)
			
			it = CreateItem("9V电池", "bat", r\x + 1930.0 * RoomScale, r\y + 97.0 * RoomScale, r\z + 256.0 * RoomScale)
			EntityParent(it\collider, r\obj)
			it = CreateItem("9V电池", "bat", r\x + 1061.0 * RoomScale, r\y + 161.0 * RoomScale, r\z + 494.0 * RoomScale)
			EntityParent(it\collider, r\obj)
			
			it = CreateItem("ReVision眼药水", "eyedrops", r\x + 1930.0*RoomScale, r\y + 225.0 * RoomScale, r\z + 128.0*RoomScale)
			EntityParent(it\collider, r\obj)
		...
		Case "room2poffices"
			...
			it = CreateItem("难以理解的笔记", "paper", r\x + 736.0 * RoomScale, r\y + 224.0 * RoomScale, r\z + 544.0 * RoomScale)
			EntityParent(it\collider, r\obj)	
			it = CreateItem("防弹背心", "vest", r\x + 608.0 * RoomScale, r\y + 112.0 * RoomScale, r\z + 32.0 * RoomScale)
			EntityParent(it\collider, r\obj) : RotateEntity(it\collider, 0, 90, 0)
			
			it = CreateItem("事故报告SCP-106-0204", "paper", r\x + 704.0 * RoomScale, r\y + 183.0 * RoomScale, r\z - 576.0 * RoomScale)
			EntityParent(it\collider, r\obj)
			it = CreateItem("一页日记", "paper", r\x + 912 * RoomScale, r\y + 176.0 * RoomScale, r\z - 160.0 * RoomScale)
			EntityParent(it\collider, r\obj)
			it = CreateItem("急救箱", "firstaid", r\x + 912.0 * RoomScale, r\y + 112.0 * RoomScale, r\z - 336.0 * RoomScale)
			EntityParent(it\collider, r\obj) : RotateEntity(it\collider, 0, 90, 0)
			;[End Block]
		Case "room2poffices2"
			;[Block]
			...
			it = CreateItem("烧焦的L博士的笔记", "paper", r\x - 688.0 * RoomScale, 1.0, r\z - 16.0 * RoomScale)
			EntityParent(it\collider, r\obj)
			
			it = CreateItem("烧焦的L博士 的笔记", "paper", r\x - 808.0 * RoomScale, 1.0, r\z - 72.0 * RoomScale)
			EntityParent(it\collider, r\obj)
			
			it = CreateItem("模块化设施项目文档", "paper", r\x + 622.0*RoomScale, r\y + 125.0*RoomScale, r\z - 73.0*RoomScale)
			EntityParent(it\collider, r\obj)
			;[End Block]
		Case "room2elevator"
			;[Block]
		...
		Case "room2cafeteria"
			...
			;"spawnpoint" for the 杯子s
			r\Objects[1] = CreatePivot(r\obj)
			PositionEntity(r\Objects[1], r\x+1780.0*RoomScale, -248.0*RoomScale, r\z-276*RoomScale, True)
			
			it = CreateItem("杯子", "杯子", r\x-508.0*RoomScale, -187*RoomScale, r\z+284.0*RoomScale, 240,175,70)
			EntityParent(it\collider, r\obj) : it\name = "Cup of Orange Juice"
			
			it = CreateItem("杯子", "杯子", r\x+1412 * RoomScale, -187*RoomScale, r\z-716.0 * RoomScale, 87,62,45)
			EntityParent(it\collider, r\obj) : it\name = "Cup of Coffee"
			
			it = CreateItem("空杯子", "emptycup", r\x-540*RoomScale, -187*RoomScale, r\z+124.0*RoomScale)
			EntityParent(it\collider, r\obj)
			
			it = CreateItem("硬币", "25ct", r\x-447.0*RoomScale, r\y-334.0*RoomScale, r\z+36.0*RoomScale)
			EntityParent(it\collider, r\obj)
			it = CreateItem("硬币", "25ct", r\x+1409.0*RoomScale, r\y-334.0*RoomScale, r\z-732.0*RoomScale)
			EntityParent(it\collider, r\obj)
			;[End Block]
		Case "room2nuke"
			;[Block]
			...
			it = CreateItem("核设备文档", "paper", r\x - 768.0 * RoomScale, r\y + 1684.0 * RoomScale, r\z - 768.0 * RoomScale)
			EntityParent(it\collider, r\obj)
			
			it = CreateItem("防弹背心", "vest", r\x - 944.0 * RoomScale, r\y + 1652.0 * RoomScale, r\z - 656.0 * RoomScale)
			EntityParent(it\collider, r\obj) : RotateEntity(it\collider, 0, -90, 0)
...
;			
			...
			EntityParent(de\obj, r\obj)
			it = CreateItem("烧焦的笔记", "paper", r\x + 64.0 * RoomScale, r\y +144.0 * RoomScale, r\z - 384.0 * RoomScale)
			EntityParent(it\collider, r\obj)
			;[End Block]
		Case "008"
			;[Block]
			...
			it = CreateItem("防护服", "hazmatsuit", r\x - 76.0 * RoomScale, 0.5, r\z - 396.0 * RoomScale)
			EntityParent(it\collider, r\obj) : RotateEntity(it\collider, 0, 90, 0)
			
			it = CreateItem("SCP-008文档", "paper", r\x - 245.0 * RoomScale, r\y + 192.0 * RoomScale, r\z + 368.0 * RoomScale)
			EntityParent(it\collider, r\obj)
		...
		Case "room035"
			...
			it = CreateItem("SCP-035附件", "paper", r\x + 248.0 * RoomScale, r\y + 220.0 * RoomScale, r\z + 576.0 * RoomScale)
			EntityParent(it\collider, r\obj)
			
			it = CreateItem("对讲机", "radio", r\x - 544.0 * RoomScale, 0.5, r\z + 704.0 * RoomScale)
			EntityParent(it\collider, r\obj)
			
			it = CreateItem("SCP-500-01", "scp500", r\x + 1168*RoomScale, 224*RoomScale, r\z+576*RoomScale)
			EntityParent(it\collider, r\obj)
			
			it = CreateItem("金属板", "scp148", r\x - 360 * RoomScale, 0.5, r\z + 644 * RoomScale)
			EntityParent(it\collider, r\obj)
			
			it = CreateItem("SCP-035文档", "paper", r\x + 1168.0 * RoomScale, 104.0 * RoomScale, r\z + 608.0 * RoomScale)
			EntityParent(it\collider, r\obj)
			;[End Block]
		Case "room513"
			;[Block]
			...
			it = CreateItem("沾血的笔记", "paper", r\x + 736.0 * RoomScale,1.0, r\z + 48.0 * RoomScale)
			EntityParent(it\collider, r\obj)
			
			it = CreateItem("SCP-513文档", "paper", r\x - 480.0 * RoomScale, 104.0*RoomScale, r\z - 176.0 * RoomScale)
			EntityParent(it\collider, r\obj)
			;[End Block]
		Case "room966"
			;[Block]
			...
			it = CreateItem("夜视仪", "nvgoggles", r\x + 320.0 * RoomScale, 0.5, r\z + 704.0 * RoomScale)
			EntityParent(it\collider, r\obj)
			it\state = 300
		...
		Case "room3storage"
			...
			it.Items = CreateItem("黑色断手", "hand2", r\x + x*RoomScale, -5596.0*RoomScale+1.0, r\z+z*RoomScale)
			EntityParent(it\collider, r\obj)
			
			it = CreateItem("夜视仪", "nvgoggles", r\x + 1936.0 * RoomScale, r\y - 5496.0 * RoomScale, r\z - 944.0 * RoomScale)
			EntityParent(it\collider, r\obj)
			it\state = 450
		...
		Case "room049"
			...
			it = CreateItem("SCP-049文档", "paper", r\x - 608.0 * RoomScale, r\y - 3332.0 * RoomScale, r\z + 876.0 * RoomScale)
			EntityParent(it\collider, r\obj)
			
			it = CreateItem("四级钥匙卡", "key4", r\x - 512.0 * RoomScale, r\y - 3412.0 * RoomScale, r\z + 864.0 * RoomScale)
			EntityParent(it\collider, r\obj)
			
			it = CreateItem("急救箱", "firstaid", r\x +385.0 * RoomScale, r\y - 3412.0 * RoomScale, r\z + 271.0 * RoomScale)
			EntityParent(it\collider, r\obj)
		...
		Case "room012"
			...
			it = CreateItem("SCP-012文档", "paper", r\x - 56.0 * RoomScale, r\y - 576.0 * RoomScale, r\z - 408.0 * RoomScale)
			EntityParent(it\collider, r\obj)
			
			it.Items = CreateItem("断手", "hand", r\x - 784*RoomScale, -576*RoomScale+0.3, r\z+640*RoomScale)
			EntityParent(it\collider, r\obj)
...
;			PositionEntity(r\Objects[6], r\x - 848*RoomScale, 0.5, r\z-576*RoomScale, True)
		...
		Case "room3servers"
			;[Block]
			it = CreateItem("9V电池", "bat", r\x - 132.0 * RoomScale, r\y - 368.0 * RoomScale, r\z - 648.0 * RoomScale)
			EntityParent(it\collider, r\obj)
			If Rand(2) = 1 Then
				it = CreateItem("9V电池", "bat", r\x - 76.0 * RoomScale, r\y - 368.0 * RoomScale, r\z - 648.0 * RoomScale)
				EntityParent(it\collider, r\obj)
			EndIf
			If Rand(2) = 1 Then
				it = CreateItem("9V电池", "bat", r\x - 196.0 * RoomScale, r\y - 368.0 * RoomScale, r\z - 648.0 * RoomScale)
				EntityParent(it\collider, r\obj)
			EndIf
			
			it = CreateItem("S-NAV 300导航仪", "nav", r\x + 124.0 * RoomScale, r\y - 368.0 * RoomScale, r\z - 648.0 * RoomScale)
			it\state = 20 : EntityParent(it\collider, r\obj)
		...
		Case "room3servers2"
			...
			it = CreateItem("SCP-970文档", "paper", r\x + 960.0 * RoomScale, r\y - 448.0 * RoomScale, r\z + 251.0 * RoomScale)
			RotateEntity it\collider, 0, r\angle, 0
			EntityParent(it\collider, r\obj)		
			
			it = CreateItem("防毒面具", "gasmask", r\x + 954.0 * RoomScale, r\y - 504.0 * RoomScale, r\z + 235.0 * RoomScale)
			EntityParent(it\collider, r\obj)		
			;[End Block]
		Case "testroom"
			;[Block]
			...
			it = CreateItem("SCP-682文档", "paper", r\x + 656.0 * RoomScale, r\y - 1200.0 * RoomScale, r\z - 16.0 * RoomScale)
			EntityParent(it\collider, r\obj)
			;[End Block]
		Case "room2closets"
			;[Block]
			it = CreateItem("SCP-1048文档", "paper", r\x + 736.0 * RoomScale, r\y + 176.0 * RoomScale, r\z + 736.0 * RoomScale)
			EntityParent(it\collider, r\obj)
			
			it = CreateItem("防毒面具", "gasmask", r\x + 736.0 * RoomScale, r\y + 176.0 * RoomScale, r\z + 544.0 * RoomScale)
			EntityParent(it\collider, r\obj)
			
			it = CreateItem("9V电池", "bat", r\x + 736.0 * RoomScale, r\y + 176.0 * RoomScale, r\z - 448.0 * RoomScale)
			EntityParent(it\collider, r\obj)
			If Rand(2) = 1 Then
				it = CreateItem("9V电池", "bat", r\x + 730.0 * RoomScale, r\y + 176.0 * RoomScale, r\z - 496.0 * RoomScale)
				EntityParent(it\collider, r\obj)
			EndIf
			If Rand(2) = 1 Then
				it = CreateItem("9V电池", "bat", r\x + 740.0 * RoomScale, r\y + 176.0 * RoomScale, r\z - 560.0 * RoomScale)
				EntityParent(it\collider, r\obj)
			EndIf
			
			it = CreateItem("一级钥匙卡", "key1", r\x + 736.0 * RoomScale, r\y + 240.0 * RoomScale, r\z + 752.0 * RoomScale)
			EntityParent(it\collider, r\obj)
			
			Local clipboard.Items = CreateItem("文件夹","clipboard",r\x + 736.0 * RoomScale, r\y + 224.0 * RoomScale, r\z -480.0 * RoomScale)
			EntityParent(it\collider, r\obj)
			
			it = CreateItem("事故报告SCP-1048-A", "paper",r\x + 736.0 * RoomScale, r\y + 224.0 * RoomScale, r\z -480.0 * RoomScale)
		...
		Case "room2offices"
			;[Block]
			it = CreateItem("SCP-106文档", "paper", r\x + 404.0 * RoomScale, r\y + 145.0 * RoomScale, r\z + 559.0 * RoomScale)
			EntityParent(it\collider, r\obj)
			
			it = CreateItem("二级钥匙卡", "key2", r\x - 156.0 * RoomScale, r\y + 151.0 * RoomScale, r\z + 72.0 * RoomScale)
			EntityParent(it\collider, r\obj)
			
			it = CreateItem("S-NAV 300导航仪", "nav", r\x + 305.0 * RoomScale, r\y + 153.0 * RoomScale, r\z + 944.0 * RoomScale)
			it\state = 20 : EntityParent(it\collider, r\obj)
			
			it = CreateItem("通知", "paper", r\x -137.0 * RoomScale, r\y + 153.0 * RoomScale, r\z + 464.0 * RoomScale)
			EntityParent(it\collider, r\obj)
		...
		Case "room2offices2"
			;[Block]
			it = CreateItem("一级钥匙卡", "key1", r\x - 368.0 * RoomScale, r\y - 48.0 * RoomScale, r\z + 80.0 * RoomScale)
			EntityParent(it\collider, r\obj)
			
			it = CreateItem("SCP-895文档", "paper", r\x - 800.0 * RoomScale, r\y - 48.0 * RoomScale, r\z + 368.0 * RoomScale)
			EntityParent(it\collider, r\obj)
			If Rand(2) = 1 Then
				it = CreateItem("SCP-860文档", "paper", r\x - 800.0 * RoomScale, r\y - 48.0 * RoomScale, r\z - 464.0 * RoomScale)
			Else
				it = CreateItem("SCP-093回收资料", "paper", r\x - 800.0 * RoomScale, r\y - 48.0 * RoomScale, r\z - 464.0 * RoomScale)
			EndIf
			EntityParent(it\collider, r\obj)
			
			it = CreateItem("S-NAV 300导航仪", "nav", r\x - 336.0 * RoomScale, r\y - 48.0 * RoomScale, r\z - 480.0 * RoomScale)
		...
		Case "room2offices3"
			;[Block]
			If Rand(2)=1 Then 
				it = CreateItem("机动特遣队文档", "paper", r\x + 744.0 * RoomScale, r\y +240.0 * RoomScale, r\z + 944.0 * RoomScale)
				EntityParent(it\collider, r\obj)	
			Else
				it = CreateItem("安保等级文档", "paper", r\x + 680.0 * RoomScale, r\y +240.0 * RoomScale, r\z + 944.0 * RoomScale)
				EntityParent(it\collider, r\obj)			
			EndIf
			
			it = CreateItem("项目等级文档", "paper", r\x + 160.0 * RoomScale, r\y +240.0 * RoomScale, r\z + 568.0 * RoomScale)
			EntityParent(it\collider, r\obj)	
			
			it = CreateItem("文档", "paper", r\x -1440.0 * RoomScale, r\y +624.0 * RoomScale, r\z + 152.0 * RoomScale)
			EntityParent(it\collider, r\obj)	
			
			it = CreateItem("对讲机", "radio", r\x - 1184.0 * RoomScale, r\y + 480.0 * RoomScale, r\z - 800.0 * RoomScale)
			EntityParent(it\collider, r\obj)				
			
			For i = 0 To Rand(0,1)
				it = CreateItem("ReVision眼药水", "eyedrops", r\x - 1529.0*RoomScale, r\y + 563.0 * RoomScale, r\z - 572.0*RoomScale + i*0.05)
				EntityParent(it\collider, r\obj)				
			Next
			
			it = CreateItem("9V电池", "bat", r\x - 1545.0 * RoomScale, r\y + 603.0 * RoomScale, r\z - 372.0 * RoomScale)
			EntityParent(it\collider, r\obj)
			If Rand(2) = 1 Then
				it = CreateItem("9V电池", "bat", r\x - 1540.0 * RoomScale, r\y + 603.0 * RoomScale, r\z - 340.0 * RoomScale)
				EntityParent(it\collider, r\obj)
			EndIf
			If Rand(2) = 1 Then
				it = CreateItem("9V电池", "bat", r\x - 1529.0 * RoomScale, r\y + 603.0 * RoomScale, r\z - 308.0 * RoomScale)
				EntityParent(it\collider, r\obj)
			EndIf
		...
		Case "room2scps"
			...
			it = CreateItem("SCP-714文档", "paper", r\x - 728.0 * RoomScale, r\y + 288.0 * RoomScale, r\z - 360.0 * RoomScale)
			EntityParent(it\collider, r\obj)
			
			it = CreateItem("SCP-427文档", "paper", r\x - 608.0 * RoomScale, r\y + 66.0 * RoomScale, r\z + 636.0 * RoomScale)
			EntityParent(it\collider, r\obj)
		...
		Case "coffin"
			...
			it = CreateItem("SCP-895文档", "paper", r\x - 688.0 * RoomScale, r\y + 133.0 * RoomScale, r\z - 304.0 * RoomScale)
			EntityParent(it\collider, r\obj)
			
			it = CreateItem("三级钥匙卡", "key3", r\x + 240.0 * RoomScale, r\y -1456.0 * RoomScale, r\z + 2064.0 * RoomScale)
			EntityParent(it\collider, r\obj)
			
			it = CreateItem("夜视仪", "nvgoggles", r\x + 280.0 * RoomScale, r\y -1456.0 * RoomScale, r\z + 2164.0 * RoomScale)
			EntityParent(it\collider, r\obj)
			it\state = 400
		...
		Case "914"
			...
			it = CreateItem("附件： 5/14测试日志", "paper", r\x +954.0 * RoomScale, r\y +228.0 * RoomScale, r\z + 127.0 * RoomScale)
			EntityParent(it\collider, r\obj)	
			
			it = CreateItem("急救箱", "firstaid", r\x + 960.0 * RoomScale, r\y + 112.0 * RoomScale, r\z - 40.0 * RoomScale)
			EntityParent(it\collider, r\obj) : RotateEntity(it\collider, 0, 90, 0)
			
			it = CreateItem("L博士的笔记", "paper", r\x - 928.0 * RoomScale, 160.0 * RoomScale, r\z - 160.0 * RoomScale)
			EntityParent(it\collider, r\obj)
			;[End Block]
		Case "173"
			;[Block]
			...
			CreateItem("D级人员培训传单", "paper", r\x-(2914+1024)*RoomScale, 170.0*RoomScale, r\z+40*RoomScale)
		...
		Case "room2ccont"
			...
			it = CreateItem("Daniel的便条", "paper", r\x-400.0*RoomScale,1040.0*RoomScale,r\z+115.0*RoomScale)
			EntityParent(it\collider, r\obj)
		...
		Case "room106"
			;[Block]
			it = CreateItem("五级钥匙卡", "key5", r\x - 752.0 * RoomScale, r\y - 592 * RoomScale, r\z + 3026.0 * RoomScale)
			EntityParent(it\collider, r\obj)
			
			it = CreateItem("Allok博士的便条", "paper", r\x - 416.0 * RoomScale, r\y - 576 * RoomScale, r\z + 2492.0 * RoomScale)
			EntityParent(it\collider, r\obj)
			
			it = CreateItem("召回协议RP-106-N", "paper", r\x + 268.0 * RoomScale, r\y - 576 * RoomScale, r\z + 2593.0 * RoomScale)
			EntityParent(it\collider, r\obj)
		...
		Case "room2test1074"
			...
			it = CreateItem("SCP-1074文档","paper",r\x + 300.0 * RoomScale,r\y+20.0*RoomScale,r\z + 671.0*RoomScale)
			EntityParent(it\collider, r\obj)
		...
		Case "room1123"
			;[Block]
			it = CreateItem("SCP-1123文档", "paper", r\x + 511.0 * RoomScale, r\y + 125.0 * RoomScale, r\z - 936.0 * RoomScale)
			EntityParent(it\collider, r\obj)
			
			it = CreateItem("SCP-1123", "1123", r\x + 832.0 * RoomScale, r\y + 166.0 * RoomScale, r\z + 784.0 * RoomScale)
			EntityParent(it\collider, r\obj)
			
			it = CreateItem("传单", "paper", r\x - 816.0 * RoomScale, r\y + 704.0 * RoomScale, r\z+ 888.0 * RoomScale)
			EntityParent(it\collider, r\obj)
			
			it = CreateItem("防毒面具", "gasmask", r\x + 457.0 * RoomScale, r\y + 150.0 * RoomScale, r\z + 960.0 * RoomScale)
			EntityParent(it\collider, r\obj)
		...
		Case "pocketdimension"
			...
			CreateItem("烧焦的文件", "paper", EntityX(r\obj),0.5,EntityZ(r\obj)+3.5)
		...
		Case "room2servers2"
			...
			it = CreateItem("夜视仪", "nvgoggles", r\x + 56.0154 * RoomScale, r\y - 648.0 * RoomScale, r\z + 749.638 * RoomScale)
			it\state = 200
		...
		Case "room1162"
			...
			it = CreateItem("SCP-1162文档", "paper", r\x + 863.227 * RoomScale, r\y + 152.0 * RoomScale, r\z - 953.231 * RoomScale)
			EntityParent(it\collider, r\obj)
		...
		Case "room2scps2"
			...
			it = CreateItem("SCP-1499文档", "paper", r\x + 840.0 * RoomScale, r\y + 260.0 * RoomScale, r\z + 224.0 * RoomScale)
			EntityParent(it\collider, r\obj)
			
			it = CreateItem("SCP-500文档", "paper", r\x + 1152.0 * RoomScale, r\y + 224.0 * RoomScale, r\z + 336.0 * RoomScale)
			EntityParent(it\collider, r\obj)
			
			it = CreateItem("艾米丽罗斯的身份证", "badge", r\x + 364.0 * RoomScale, r\y + 5.0 * RoomScale, r\z + 716.0 * RoomScale)
			EntityParent(it\collider, r\obj)
		...
		Case "room2offices4"
			...
			it = CreateItem("便利贴", "paper", r\x - 991.0*RoomScale, r\y - 242.0*RoomScale, r\z + 904.0*RoomScale)
			EntityParent(it\collider, r\obj)
			;[End Block]
		Case "room2sl"
			;[Block]
...
;			RotateEntity r\Objects[21],8.6,-150.0,-5.0
		...
		Case "medibay"
			...
			it = CreateItem("急救箱", "firstaid", r\x - 506.0 * RoomScale, r\y + 192.0 * RoomScale, r\z - 322.0 * RoomScale)
			EntityParent(it\collider, r\obj)
			it = CreateItem("针筒", "syringe", r\x - 333.0 * RoomScale, r\y + 100.0 * RoomScale, r\z + 97.3 * RoomScale)
			EntityParent(it\collider, r\obj)
			it = CreateItem("针筒", "syringe", r\x - 340.0 * RoomScale, r\y + 100.0 * RoomScale, r\z + 52.3 * RoomScale)
			EntityParent(it\collider, r\obj)
		...
		Case "room2cpit"
			...
			it = CreateItem("L博士 的笔记", "paper", r\x - 160.0 * RoomScale, 32.0 * RoomScale, r\z - 353.0 * RoomScale)
			EntityParent(it\collider, r\obj)
			;[End Block]
		Case "dimension1499"
			;[Block]
